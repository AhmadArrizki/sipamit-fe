...
const EditKomputerPH2 = () => {
  const { id } = useParams(); // Get the Komputer PH2 ID from the URL
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const data = await response.json();
      setSuccess(`Komputer PH2 berhasil diupdate: ${data.nama}`);
      setFormData({
        cpu: "",
        internal: "",
        lokasi: "",
  ...
  return (
    <div className="mt-12">
      <h1 className="text-2xl font-semibold mb-4">Edit Komputer PH2</h1>
...
export default EditKomputerPH2;
