...
const AddFingerprint = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost:5051/api/fingerprint", {
        method: "POST",
        headers: {
      ...
      setSuccess(`Fingerprint berhasil ditambahkan: ${data.nama}`);
  ...
  return (
    <div className="mt-12">
      <h1 className="text-2xl font-semibold mb-4">Tambah Fingerprint</h1>
