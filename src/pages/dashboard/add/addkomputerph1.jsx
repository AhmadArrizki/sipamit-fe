...
const AddKomputerPH1 = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost:5051/api/komputer-ph1", {
        method: "POST",
        headers: {
      ...
      setSuccess(`Komputer PH1 berhasil ditambahkan: ${data.nama}`);
  ...
  return (
    <div className="mt-12">
      <h1 className="text-2xl font-semibold mb-4">Tambah Komputer PH1</h1>
